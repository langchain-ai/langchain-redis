...
class RedisConfig(BaseModel):
    ...
    Attributes:
        ...
        connection_args (Optional[Dict[str, Any]]): Additional Redis connection args.
        ...
        storage_type (str): Storage type in Redis.
            ...
            Defaults to `'hash'`.
        id_field (str): Field name for document ID.

            Defaults to `'id'`.
        content_field (str): Field name for document content.

            Defaults to `'text'`.
        embedding_field (str): Field name for embedding vector.

            Defaults to `'embedding'`.
        default_tag_separator (str): Separator for tag fields.
    ...
    def from_schema(cls, schema: IndexSchema, **kwargs: Any) -> "RedisConfig":
        ...
        Returns:
            RedisConfig: A new instance of `RedisConfig` configured based on the
                provided schema and kwargs.
        ...
        Note:
            ...
            - The resulting config can be used to ensure that a `RedisVectorStore`
                matches an existing index structure.
        """
    ...
    def from_existing_index(cls, index_name: str, redis: Redis) -> "RedisConfig":
        ...
        Returns:
            RedisConfig: A new instance of `RedisConfig` configured to match the
                existing index.
        ...
        Note:
            - This method sets the `'from_existing'` attribute to `True`, indicating
    ...
    def to_index_schema(self) -> IndexSchema:
        ...
        Raises:
            ValueError: If essential configuration elements (like
                `embedding_dimensions`) are missing.
        """
    ...
    def is_sentinel_url(self) -> bool:
        ...
        Returns:
            bool: `True` if the URL uses the `redis+sentinel://` scheme, `False`
                otherwise.
        """
